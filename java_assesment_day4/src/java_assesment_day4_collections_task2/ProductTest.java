        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    scanner.nextLine();
                    Product productToDelete = new Product(idToDelete, ""); // Dummy product for deletion
                    int deleteResult = ps.deleteProduct(productToDelete);
                    System.out.println(deleteResult == 1 ? "Product deleted." : "Product not found.");
                    break;
                case 3:
                    ...
                    System.out.println(updateResult == 1 ? "Product updated." : "Product not found.");
                    break;
                case 4:
                    ps.listProducts();
                    break;
